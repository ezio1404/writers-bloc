    ...
    <ul class="space-y-2 text-sm">
        ...
        <li>
            <a href="{{ route('teacher-report')}}"
                class="flex items-center space-x-3 text-gray-700 p-2 rounded-md font-medium hover:bg-gray-200 @if(Request::path() === 'teacher/report') bg-gray-200 font-bold @else focus:bg-gray-200 @endif  focus:shadow-outline">
                <span class="text-gray-600">
                    <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
