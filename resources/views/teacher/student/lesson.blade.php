...
<nav class="text-black" aria-label="Breadcrumb">
    <ol class="list-none p-0 inline-flex">
        ...
        <li class="flex items-center">
            <a href={{ route('teacher-show-student', ['userId'=>$student->id]) }}>{{$student->name}}</a>
            <x-chevron />
        </li>
        <li class="flex items-center">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap ">
                                                <div class="text-sm font-medium text-gray-900">
                                                    {{-- {{dd($studentQuizAnswer->quiz->question)}} --}}
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex">
                                                @if ($studentQuizAnswer->quiz->type == 'essay')
                                                <a href="{{route('teacher-grade-quiz',['studentLogId' => $student->studentLogs->first()->id, 'quizId' => $studentQuizAnswer->quiz->id])}}"
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex">
                                                <a href="{{route('teacher-grade-writing-task',['studentLogId' => $student->studentLogs->first()->id, 'writingTaskId' => $studentWritingTaskAnswer->writingTask->id])}}"
                                                    class="text-indigo-600 hover:text-indigo-900 bg-indigo-100 p-2 rounded mr-2">
                                                    Grade</a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    {{$studentLogs->student_writing_task_answer_sum_points ?? '-'}}
                                                </div>
                                            </td>
                                        </tr>
                                        @endif
