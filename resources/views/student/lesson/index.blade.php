        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
            ...
            <div class="lg:py-16 container mx-auto">
                <div class="lg:px-10 my-4 py-6 bg-white px-4 ">
                    ...
                    <p
                  class="p-2 inline-block text-normal leading-5 font-semibold rounded-full bg-green-100 text-green-800"
                    >
                        Quiz points: {{ $studentLog->student_quiz_answer_sum_points ? $studentLog->student_quiz_answer_sum_points : 'To Be Graded' }}</p>
                    <p class="p-2 inline-block text-normal leading-5 font-semibold rounded-full bg-green-100 text-green-800">Writing Task points: {{$studentLog->student_writing_task_answer_sum_points ? $studentLog->student_writing_task_answer_sum_points : 'To Be Graded'  }}
                    </p>
                    <div class="mt-2">
